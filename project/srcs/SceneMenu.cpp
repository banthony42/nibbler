...
void SceneMenu::drawScene() {
	...
	if (this->_page == PAGE_MENU) {
		...
		(*this->_aGraphics)->putStrScreen(this->_inputName[MENU_EXIT], this->_input[MENU_EXIT].x, this->_input[MENU_EXIT].y, SIZE_FONT_MENU);
	}
	...
	if (this->_page == PAGE_OPTION) {
		...
		(*this->_aGraphics)->putStrScreen("Choose a library to run:",
										  ...
										  SIZE_FONT_MENU);
		(*this->_aGraphics)->putStrScreen(this->_inputName[OPTION_SDL], this->_input[OPTION_SDL].x, this->_input[OPTION_SDL].y, SIZE_FONT_MENU);
		(*this->_aGraphics)->putStrScreen(this->_inputName[OPTION_SFML], this->_input[OPTION_SFML].x, this->_input[OPTION_SFML].y, SIZE_FONT_MENU);
		(*this->_aGraphics)->putStrScreen(this->_inputName[OPTION_GL], this->_input[OPTION_GL].x, this->_input[OPTION_GL].y, SIZE_FONT_MENU);
	}
